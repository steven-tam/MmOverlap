    ...
    <div className = "mt-1 md:w-auto md:max-w-[1280px] h-[60px] bg-white border-b">
      ...
      <nav className={toggle?'relative mt-2 z-10 p-7 bg-white px-8 shadow rounded z-20':'hidden' }>
        <ul className='flex flex-col gap-4'>
            <li><a href="/" className='block p-2 pl-4 hover:bg-gray-100 rounded-md w-5/6 sm:w-auto md:max-w-[1180px] text-gopher-maroon'>Select Major</a></li>
            ...
            <li><a href="/showResults" className='block p-2 pl-4 hover:bg-gray-100 rounded-md w-5/6 sm:w-auto md:max-w-[1180px] text-gopher-maroon'>Show Results</a></li>
