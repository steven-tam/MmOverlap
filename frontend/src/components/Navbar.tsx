    ...
    <div className = "mt-1 md:w-auto md:max-w-[1280px] h-[60px] bg-transparent border-b">
      ...
      <nav className={toggle?'relative mt-2 z-10 p-7 bg-offwhite px-8 shadow-md rounded z-20':'hidden' }>
        <ul className='flex flex-col gap-4'>
            <li><a href="/" className='block p-2 pl-4 hover:underline hover:bg-navgray rounded-md md:max-w-full text-gopher-maroon'>Home</a></li>
            <li><a href="/selectCourses" className='block p-2 pl-4 hover:underline hover:bg-navgray rounded-md md:max-w-full text-gopher-maroon'>Select Courses</a></li>
            <li><a href="/showResults" className='block p-2 pl-4 hover:bg-navgray rounded-md md:max-w-full text-gopher-maroon'>Show Results</a></li>
